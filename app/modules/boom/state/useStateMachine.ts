...
import * as actions from '~/modules/boom/state/actions';
...
export function useStateMachine(data: DrawingAppData) {
    return useStateDesigner({
        ...
        on: {
            ...
            SET_ACTIVE_COLOR: 'setActiveColor',
            SET_PENCIL_SIZE: 'setPencilSize',
            SET_PENCIL_OPACITY: 'setPencilOpacity',
...
export declare type MachineType = ReturnType<typeof useStateMachine>;
