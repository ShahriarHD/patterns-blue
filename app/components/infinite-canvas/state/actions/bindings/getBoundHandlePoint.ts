...
import { BINDING_PADDING, DrawingAppData } from '../../constants';
...
export function getBoundHandlePoint(
    ...
    const oppositeBinding = Object
        .values(data.page.bindings)
        .find(binding => binding.fromId === fromShape.id && binding.handleId === oppositeHandleId);
